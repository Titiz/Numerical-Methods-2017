...
from main import *
from pylab import *
''' This file is used for graphing the error with respect to different iteration amounts. Here zeros were generated,
expanded and the expansion gave a polynomial with known zeros. The polynomial are solved numerically and the
approximated zeros are compared to the initially generated ones.
'''
if __name__ == "__main__":
    ...
    iteration_numbers = [2, 3, 5, 10]  # What numbers of iterations the program should use
    h = 0.01 # timestep
    ...
    for iteration_number in iteration_numbers:
        ...
        for degree in range(lowest_order, highest_order+1):  # We iterate through each degree.
            ...
            for j in range(tests_per_order):
                ...
                difference = absolute(correct_zeros - p.time_zeros)
    ...
    legend(["2", "3", "5", "10"], loc='lower left')
    show()
